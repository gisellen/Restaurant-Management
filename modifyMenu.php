    ...
    <body>
        ...
        if($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
                echo $row["menu_item"]." $".$row["price"]."<br>";
            }
        }
        ?>
        <form action="modifyMenu.php" method="POST">
        <input class="btn btn-dark" class="add" type="submit" name="addItem" value="Add Item">
        <input class="btn btn-dark" onclick="myFunction()" type="submit" name="deleteItem" value="Delete Item">
